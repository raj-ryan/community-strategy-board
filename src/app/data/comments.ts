...
export const SEED_COMMENTS: Record<number, Comment[]> = {
  ...
  4: [
    c(
      ...
      "Year 1",
      "1 week ago",
      "Booking the non-urgent work into an actual slot was the only version of this that survived past week 3 for me.",
      12,
      { outcome: "worked" },
    ),
  ],
  6: [
    c(
      ...
      "Year 2",
      "5 days ago",
      "The three-day 'start' reminder is what made the difference. The due-date one only ever told me I was already behind.",
      14,
      { outcome: "worked" },
    ),
  ],
  7: [
    c(
      ...
      "Year 2",
      "3 days ago",
      "Does the Course Summary table show ungraded items like readings, or only assignments with dates?",
      6,
      {
        replies: [
          r(
            ...
            "Year 2",
            "3 days ago",
            "Anything with a date attached, including calendar events. Readings only appear if the instructor gave them a date.",
            9,
            true,
          ),
        ],
  ...
  8: [
    c(
      ...
      "Year 1",
      "1 week ago",
      "Asked this in two courses. One said Canvas announcements, the other said they would say it in class only, which was exactly the course where I would have missed it.",
      17,
      { outcome: "worked" },
    ),
  ],
  10: [
    c(
      ...
      "Year 2",
      "6 days ago",
      "Two of my four courses never used Announcements once. Knowing that in week 1 saved a lot of pointless checking.",
      11,
      { outcome: "worked" },
    ),
  ],
  11: [
    c(
      ...
      "Year 1",
      "4 days ago",
      "Can students change the course home page, or only instructors?",
      5,
      {
        replies: [
          r(
            ...
            "Year 2",
            "4 days ago",
            "Only instructors. That is why the fallback is bookmarking the announcements URL for each course.",
            8,
            true,
          ),
        ],
  ...
  12: [
    c(
      ...
      "Year 2",
      "1 week ago",
      "Found two announcements I had never seen in Canvas sitting in my inbox from week 2.",
      9,
      { outcome: "worked" },
    ),
  ],
  14: [
    c(
      ...
      "Year 1",
      "5 days ago",
      "Keeping the original filenames is the part people skip and then regret, because that is what makes search work later.",
      13,
      { outcome: "worked" },
    ),
  ],
  15: [
    c(
      ...
      "Year 2",
      "1 week ago",
      "Found next week's dataset in Files three days before it appeared in Modules.",
      10,
      { outcome: "worked" },
    ),
  ],
  17: [
    c(
      ...
      "Year 1",
      "4 days ago",
      "Turning off submission confirmations alone cut my Canvas email roughly in half.",
      15,
      { outcome: "worked" },
    ),
  ],
  18: [
    c(
      ...
      "Year 1",
      "2 days ago",
      "Does filtering to a folder risk missing something urgent?",
      7,
      {
        replies: [
          r(
            ...
            "Year 2",
            "2 days ago",
            "That is why the announcement and grading notifications stay immediate. The folder is for the routine traffic only.",
            12,
            true,
          ),
        ],
  ...
  19: [
    c(
      ...
      "Year 1",
      "1 week ago",
      "Weekly discussion posts in a 40-person seminar were most of my notifications. Turning replies off and keeping mentions on fixed it without missing anything addressed to me.",
      12,
      { outcome: "worked" },
    ),
  ],
  20: [
    c(
      ...
      "Year 1",
      "6 days ago",
      "Choosing email as the only channel that reaches my phone was uncomfortable for about a week and then obviously right.",
      11,
      { outcome: "worked" },
    ),
  ],
  22: [
    c(
      ...
      "Year 1",
      "1 week ago",
      "Task, person, date. We added a fourth column for 'what done looks like' and that removed most of the disagreements.",
      16,
      { outcome: "adapted" },
    ),
  ],
  24: [
    c(
      ...
      "Year 1",
      "5 days ago",
      "Posting my time zone first made it normal for everyone else to do it. Before that, people assumed I was slow to reply rather than asleep.",
      20,
      { outcome: "worked" },
    ),
  ],
  25: [
    c(
      ...
      "Year 1",
      "1 week ago",
      "The communication section told me the response window was 48 hours, which stopped me from panicking on day one and sending a second email.",
      13,
      { outcome: "worked" },
    ),
  ],
  26: [
    c(
      ...
      "Year 1",
      "4 days ago",
      "Found a resubmission request in a rubric comment that had produced no notification at all.",
      18,
      { outcome: "worked" },
    ),
  ],
  27: [
    c(
      ...
      "Year 1",
      "1 week ago",
      "Asked something small in week 1 and learned that this instructor replies within a day on Canvas but never by email. Useful before I needed it.",
      12,
      { outcome: "worked" },
    ),
  ],
  29: [
    c(
      ...
      "Year 1",
      "6 days ago",
      "Having questions written down is the only reason I speak in seminar at all. I stopped waiting for the perfect moment.",
      19,
      { outcome: "worked" },
    ),
  ],
  30: [
    c(
      ...
      "Year 2",
      "3 days ago",
      "Which manager handles non-Latin scripts best? Mine keeps mangling the transliteration.",
      6,
      {
        replies: [
          r(
            ...
            "Year 2",
            "3 days ago",
            "Zotero handles it once you set the language field per item. Worth fixing on entry rather than at the end.",
            9,
            true,
          ),
        ],
  ...
  31: [
    c(
      ...
      "Year 1",
      "5 days ago",
      "Doing the set in the session rather than after it cut my time on problem sets by about half.",
      14,
      { outcome: "worked" },
    ),
  ],
  32: [
    c(
      ...
      "Year 1",
      "1 week ago",
      "The access window closed a week before my deadline and I had planned as if it were open. Now the appointment goes in first.",
      10,
      { outcome: "worked" },
    ),
  ],
  33: [
    c(
      ...
      "Year 1",
      "1 week ago",
      "Not my program, but the same idea worked for me with a conference week. Get the fixed calendar first, plan coursework around it.",
      8,
      { outcome: "adapted" },
    ),
  ],
  35: [
    c(
      ...
      "Year 1",
      "6 days ago",
      "License approval took four working days for me. Starting in week 0 was the only reason the first assignment was on time.",
      15,
      { outcome: "worked" },
    ),
  ],
  36: [
    c(
      ...
      "Year 1",
      "1 week ago",
      "The district calendar and the University calendar disagreed on two weeks. Finding that in week 1 rather than week 6 was the whole value.",
      12,
      { outcome: "worked" },
    ),
  ],
  37: [
    c(
      ...
      "Year 2",
      "5 days ago",
      "Photographing the setup and instrument settings saved a whole report when my written notes turned out to be incomplete.",
      16,
      { outcome: "worked" },
    ),
  ],
  38: [
    c(
      ...
      "Year 2",
      "4 days ago",
      "How do you raise this without sounding like you are asking to do less research?",
      11,
      {
        replies: [
          r(
            ...
            "Year 2",
            "4 days ago",
            "Bring the course schedule and ask which weeks they would prefer you protect. It reads as planning rather than negotiating, and most advisers appreciate knowing in advance.",
            17,
            true,
          ),
        ],
  ...
  39: [
    c(
      ...
      "Year 2",
      "1 week ago",
      "A field day was announced only by email from a coordinator who was not on the Canvas site. Asking in week 1 is exactly right.",
      9,
      { outcome: "worked" },
    ),
  ],
  40: [
    c(
      ...
      "Year 1",
      "5 days ago",
      "No signal at the site and the protocol was a link. Printed copies since then.",
      11,
      { outcome: "worked" },
    ),
  ],
  42: [
    c(
      ...
      "Year 1",
      "1 week ago",
      "Requested everything on the same day and two of the four took over a week. Worth knowing which ones are slow.",
      10,
      { outcome: "worked", isContributor: true },
    ),
  ],
  43: [
    c(
      ...
      "Year 1",
      "6 days ago",
      "The one-line note about why the source matters is the part that saves time later, more than the citation itself.",
      14,
      { outcome: "worked", isContributor: true },
    ),
  ],
  45: [
    c(
      ...
      "Year 1",
      "1 week ago",
      "Training certificates took two weeks to come through. The fallback dataset kept the project moving.",
      12,
      { outcome: "worked" },
    ),
  ],
  46: [
    c(
      ...
      "Year 1",
      "5 days ago",
      "Same problem in clinical placements. Logging the same day is the only version that survives a busy week.",
      9,
      { outcome: "worked" },
    ),
  ],
  47: [
    c(
      ...
      "Year 2",
      "1 week ago",
      "Placement changes never appear in Canvas. Finding the right system in week 1 is essential.",
      13,
      { outcome: "worked" },
    ),
  ],
  48: [
    c(
      ...
      "Year 1",
      "4 days ago",
      "Re-planning at the start of each block rather than carrying the old rhythm forward was the part that actually helped.",
      10,
      { outcome: "worked", isContributor: true },
    ),
  ],
  49: [
    c(
      ...
      "Year 1",
      "3 days ago",
      "If a course accepts either R or Stata, does it matter which you pick?",
      7,
      {
        replies: [
          r(
            ...
            "Year 2",
            "3 days ago",
            "Pick the one the TA uses. Support during the quarter matters more than the tool.",
            15,
          ),
        ],
      },
  ...
  50: [
    c(
      ...
      "Year 1",
      "1 week ago",
      "Putting the recommendation in the first paragraph felt wrong coming from an essay tradition, and it was exactly what the rubric wanted.",
      21,
      { outcome: "worked", isContributor: true },
    ),
  ],
